...
public class ExoPlayerHlsTestActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    View.OnClickListener loadListener = new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (v.equals(buttonLoadFile)) {
          exoPlayer.prepare(buildMediaSource("https://s3.ap-northeast-2.amazonaws.com/gb-tv/95/broadcasts/184/vod.m3u8"));
        } else {
